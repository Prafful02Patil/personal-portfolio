    ...
    return (
        <section id='home' className='h-custom-screen-lg md:h-custom-screen-md flex justify-between items-center'>
            <div className='*:my-4 flex flex-col'>
                ...
                <h1 className='font-semibold text-5xl sm:text-4xl text-light-theme bottom'>Hi, I'm Prafful</h1>
                ...
                <div className='flex *:flex *:justify-center *:items-center *:px-3 *:py-1 *:bg-light-theme *:text-white *:rounded-md *:text-lg'>
                    ...
                    <a className='bottom' href="/resume/PraffulPatil.pdf" download={true}>Download CV <span className='ml-2'><FileDownloadOutlinedIcon /></span> </a>
                </div>

            </div>
            <div className='flex items-center justify-end w-full md:hidden'>
                <img src="/images/myphoto1.jpg" alt="Prafful Patil" className='rounded-full w-w25 lg:w-w22 top' />
            </div>
        </section>
    )
}
