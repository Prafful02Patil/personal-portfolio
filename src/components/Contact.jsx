    ...
    <>
      <section id="contact" className='h-96 flex flex-col justify-center items-center *:my-4 pt-4'>
        ...
        <div className='flex justify-between md:block items-center border border-gray-500 rounded-lg p-4 bottom'>
          <a href="mailto:praffulpatil022019@gmail.com" target='_blank'>
            <p className='flex items-center mr-8 md:mr-0'><EmailIcon style={{ fontSize: "30px" }} className='text-white bg-blue-900 p-1 rounded-full' /><span className='text-lg ml-2 dark:text-white'>praffulpatil022019@gmail.com</span></p>
          </a>
          <a href="https://www.linkedin.com/in/prafful-patil-a5372326a
